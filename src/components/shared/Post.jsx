...
import { edit, locationPin, deleteIcon } from '../../../public/assets/icons';
                ...
                <div className="flex-between">
                    <div className="flex gap-4">
                        ...
                        <div className="flex-1 flex flex-col">
                            ...
                            <div className="flex-1 flex-between pr-4 text-small font-system font-semibold text-subtitle">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    {location && (
                        <div className="flex-start gap-2">
                            ...
                            />
                            <p className="text-medium font-system">
                                {location}
                            </p>
                        </div>
                    )}
